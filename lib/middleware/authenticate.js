  ...
  return function authenticate(req, res, next) {
    ...
    function allFailed() {
      ...
      if (typeof options.failure == "function") {
          return options.failure(req, options);
      } else if (typeof options.failure == "string") {
        return res.redirect(options.failure);
        ...
        req.logIn(user, options, function(err) {
          ...
          function complete() {
            ...
            if (typeof options.success == "function") {
                return options.success(req, options);
            } else if (typeof options.success == "string") {
              return res.redirect(options.success);
